            ...
            try
            {
        ...
        
                {
                    ...
                    ;
                    {
                        UnityEngine.ParticleSystemCustomData arg0 = (UnityEngine.ParticleSystemCustomData)StaticTranslate<int>.Get((int)data, isolate, Puerts.NativeValueApi.GetValueFromArgument, v8Value0, false);
                        int arg1 = (int)PuertsDLL.GetNumberFromValue(isolate, v8Value1, false);
                        UnityEngine.ParticleSystem.MinMaxCurve arg2 = argobj2 != null ? (UnityEngine.ParticleSystem.MinMaxCurve)argobj2 : StaticTranslate<UnityEngine.ParticleSystem.MinMaxCurve>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value2, false);;
        ...
        internal static void M_SetColor(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        
                {
                    ...
                    {
                        UnityEngine.ParticleSystemCustomData arg0 = (UnityEngine.ParticleSystemCustomData)StaticTranslate<int>.Get((int)data, isolate, Puerts.NativeValueApi.GetValueFromArgument, v8Value0, false);
                        UnityEngine.ParticleSystem.MinMaxGradient arg1 = argobj1 != null ? (UnityEngine.ParticleSystem.MinMaxGradient)argobj1 : StaticTranslate<UnityEngine.ParticleSystem.MinMaxGradient>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false);;
