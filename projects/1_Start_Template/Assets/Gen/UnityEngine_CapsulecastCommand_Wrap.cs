        ...
        internal static void F_ScheduleBatch(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 4)
                {
                    ...
                    {
                        Unity.Collections.NativeArray<UnityEngine.CapsulecastCommand> arg0 = argobj0 != null ? (Unity.Collections.NativeArray<UnityEngine.CapsulecastCommand>)argobj0 : StaticTranslate<Unity.Collections.NativeArray<UnityEngine.CapsulecastCommand>>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
