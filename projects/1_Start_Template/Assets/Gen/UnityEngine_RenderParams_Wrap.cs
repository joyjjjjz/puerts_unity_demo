    ...
    // ==================== properties start ====================
        ...
        internal static void S_lightProbeProxyVolume(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(isolate, info, 0);
                object argobj0 = null;
                UnityEngine.LightProbeProxyVolume arg0 = argobj0 != null ? (UnityEngine.LightProbeProxyVolume)argobj0 : StaticTranslate<UnityEngine.LightProbeProxyVolume>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
