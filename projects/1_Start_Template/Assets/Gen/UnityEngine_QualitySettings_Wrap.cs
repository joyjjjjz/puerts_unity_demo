...
#pragma warning disable 0219
    ...
    // ==================== methods start ====================
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void F_GetAllRenderPipelineAssetsForPlatform(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        
                {
                    ...
                    ;
                    {
                        ...
                        System.Collections.Generic.List<UnityEngine.Rendering.RenderPipelineAsset> arg1 = argobj1 != null ? (System.Collections.Generic.List<UnityEngine.Rendering.RenderPipelineAsset>)argobj1 : StaticTranslate<System.Collections.Generic.List<UnityEngine.Rendering.RenderPipelineAsset>>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, true);;

                        UnityEngine.QualitySettings.GetAllRenderPipelineAssetsForPlatform (arg0, ref arg1);

                        StaticTranslate<System.Collections.Generic.List<UnityEngine.Rendering.RenderPipelineAsset>>.Set((int)data, isolate, Puerts.NativeValueApi.SetValueToByRefArgument, v8Value1, arg1);
                    }
                }
            }
            catch (Exception e)
