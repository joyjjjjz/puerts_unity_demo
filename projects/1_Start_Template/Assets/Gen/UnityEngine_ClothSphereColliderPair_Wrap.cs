        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    {
                        UnityEngine.SphereCollider arg0 = argobj0 != null ? (UnityEngine.SphereCollider)argobj0 : StaticTranslate<UnityEngine.SphereCollider>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
                ...
                if (paramLen == 2)
                {
                    ...
                    {
                        UnityEngine.SphereCollider arg0 = argobj0 != null ? (UnityEngine.SphereCollider)argobj0 : StaticTranslate<UnityEngine.SphereCollider>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
                        UnityEngine.SphereCollider arg1 = argobj1 != null ? (UnityEngine.SphereCollider)argobj1 : StaticTranslate<UnityEngine.SphereCollider>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false);;
