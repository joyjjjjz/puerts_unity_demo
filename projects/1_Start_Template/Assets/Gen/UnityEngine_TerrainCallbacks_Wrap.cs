    ...
    // ==================== events start ====================
        ...
        internal static void A_heightmapChanged(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                object argobj0 = null;
                UnityEngine.TerrainCallbacks.HeightmapChangedCallback arg0 = argobj0 != null ? (UnityEngine.TerrainCallbacks.HeightmapChangedCallback)argobj0 : StaticTranslate<UnityEngine.TerrainCallbacks.HeightmapChangedCallback>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
        ...
        internal static void A_textureChanged(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(isolate, info, 0);
                object argobj0 = null;
                UnityEngine.TerrainCallbacks.TextureChangedCallback arg0 = argobj0 != null ? (UnityEngine.TerrainCallbacks.TextureChangedCallback)argobj0 : StaticTranslate<UnityEngine.TerrainCallbacks.TextureChangedCallback>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
