        ...
        internal static void M_SetSprite(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        
                {
                    ...
                    {
                        int arg0 = (int)PuertsDLL.GetNumberFromValue(isolate, v8Value0, false);
                        UnityEngine.Sprite arg1 = argobj1 != null ? (UnityEngine.Sprite)argobj1 : StaticTranslate<UnityEngine.Sprite>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false);;
