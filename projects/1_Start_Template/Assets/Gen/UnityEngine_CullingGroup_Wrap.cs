        ...
        internal static void M_SetBoundingSpheres(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        
                {
                    ...
                    ;
                    {
                        UnityEngine.BoundingSphere[] arg0 = argobj0 != null ? (UnityEngine.BoundingSphere[])argobj0 : StaticTranslate<UnityEngine.BoundingSphere[]>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
    ...
    // ==================== properties start ====================
        ...
        internal static void S_onStateChanged(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(isolate, info, 0);
                object argobj0 = null;
                UnityEngine.CullingGroup.StateChanged arg0 = argobj0 != null ? (UnityEngine.CullingGroup.StateChanged)argobj0 : StaticTranslate<UnityEngine.CullingGroup.StateChanged>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
