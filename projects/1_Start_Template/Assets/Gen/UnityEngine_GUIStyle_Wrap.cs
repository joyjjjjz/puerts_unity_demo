    ...
    // ==================== properties start ====================
        ...
        internal static void S_normal(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(isolate, info, 0);
                object argobj0 = null;
                UnityEngine.GUIStyleState arg0 = argobj0 != null ? (UnityEngine.GUIStyleState)argobj0 : StaticTranslate<UnityEngine.GUIStyleState>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
                obj.normal = arg0;
            }
            catch (Exception e)
            {
        ...
        internal static void S_border(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(isolate, info, 0);
                object argobj0 = null;
                UnityEngine.RectOffset arg0 = argobj0 != null ? (UnityEngine.RectOffset)argobj0 : StaticTranslate<UnityEngine.RectOffset>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
                obj.border = arg0;
            }
            catch (Exception e)
            {
