...
#pragma warning disable 0219
    ...
    public static class UnityEngine_ColorUsageAttribute_Wrap 
    {
        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to " + typeof(UnityEngine.ColorUsageAttribute).GetFriendlyName() + " constructor");
            } catch (Exception e) {
    ...
    // ==================== properties start ====================
        ...
        internal static void G_showAlpha(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
