...
#pragma warning disable 0219
        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    if (ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.NativeObject, typeof(UnityEngine.PropertyName), false, false, v8Value0, ref argobj0, ref argType0))
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to " + typeof(UnityEngine.PropertyName).GetFriendlyName() + " constructor");
            } catch (Exception e) {
    ...
    // ==================== methods start ====================
        ...
        internal static void F_IsNullOrEmpty(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            {
                {
                    ...
                    {
                        UnityEngine.PropertyName arg0 = argobj0 != null ? (UnityEngine.PropertyName)argobj0 : StaticTranslate<UnityEngine.PropertyName>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
                        UnityEngine.PropertyName arg1 = argobj1 != null ? (UnityEngine.PropertyName)argobj1 : StaticTranslate<UnityEngine.PropertyName>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false);;
