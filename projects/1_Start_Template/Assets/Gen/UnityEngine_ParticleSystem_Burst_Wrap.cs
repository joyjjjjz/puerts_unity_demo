        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 2)
                {
                    ...
                    {
                        float arg0 = (float)PuertsDLL.GetNumberFromValue(isolate, v8Value0, false);
                        UnityEngine.ParticleSystem.MinMaxCurve arg1 = argobj1 != null ? (UnityEngine.ParticleSystem.MinMaxCurve)argobj1 : StaticTranslate<UnityEngine.ParticleSystem.MinMaxCurve>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false);;
                        var result = new UnityEngine.ParticleSystem.Burst(arg0, arg1);
