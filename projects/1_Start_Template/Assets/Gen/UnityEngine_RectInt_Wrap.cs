        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 2)
                {
                    ...
                    {
                        UnityEngine.Vector2Int arg0 = argobj0 != null ? (UnityEngine.Vector2Int)argobj0 : StaticTranslate<UnityEngine.Vector2Int>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to " + typeof(UnityEngine.RectInt).GetFriendlyName() + " constructor");
            } catch (Exception e) {
        ...
        internal static void M_Equals(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    object argobj0 = null;
                    JsValueType argType0 = JsValueType.Invalid;
                    if (ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.NativeObject, typeof(UnityEngine.RectInt), false, false, v8Value0, ref argobj0, ref argType0))
                    {
                        UnityEngine.RectInt arg0 = argobj0 != null ? (UnityEngine.RectInt)argobj0 : StaticTranslate<UnityEngine.RectInt>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
