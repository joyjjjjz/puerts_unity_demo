        ...
        internal static void M_SetCollider(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        
                {
                    ...
                    {
                        int arg0 = (int)PuertsDLL.GetNumberFromValue(isolate, v8Value0, false);
                        UnityEngine.Component arg1 = argobj1 != null ? (UnityEngine.Component)argobj1 : StaticTranslate<UnityEngine.Component>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false);;
