        ...
        internal static void M_CompareTo(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        
                {
                    ...
                    ;
                    {
                        UnityEngine.RaycastHit2D arg0 = argobj0 != null ? (UnityEngine.RaycastHit2D)argobj0 : StaticTranslate<UnityEngine.RaycastHit2D>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
