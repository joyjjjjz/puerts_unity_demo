...
#pragma warning disable 0219
        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 2)
                {
                    ...
                    if (ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.NativeObject, typeof(UnityEngine.Vector3), false, false, v8Value0, ref argobj0, ref argType0) && ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.NativeObject, typeof(UnityEngine.Quaternion), false, false, v8Value1, ref argobj1, ref argType1))
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to " + typeof(UnityEngine.Pose).GetFriendlyName() + " constructor");
            } catch (Exception e) {
    ...
    // ==================== methods start ====================
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void M_GetTransformedBy(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.Pose)Puerts.Utils.GetSelf((int)data, self);
                ...
                if (paramLen == 1)
                {
                    ...
                    object argobj0 = null;
                    JsValueType argType0 = JsValueType.Invalid;
                    if (ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.NativeObject, typeof(UnityEngine.Pose), false, false, v8Value0, ref argobj0, ref argType0))
                    {
                        UnityEngine.Pose arg0 = argobj0 != null ? (UnityEngine.Pose)argobj0 : StaticTranslate<UnityEngine.Pose>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
            ...
            {
                {
                    ...
                    {
                        UnityEngine.Pose arg0 = argobj0 != null ? (UnityEngine.Pose)argobj0 : StaticTranslate<UnityEngine.Pose>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
                        UnityEngine.Pose arg1 = argobj1 != null ? (UnityEngine.Pose)argobj1 : StaticTranslate<UnityEngine.Pose>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false);;
