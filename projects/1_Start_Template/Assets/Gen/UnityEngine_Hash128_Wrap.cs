...
#pragma warning disable 0219
        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 4)
                {
                    ...
                    if (ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.Number, typeof(uint), false, false, v8Value0, ref argobj0, ref argType0) && ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.Number, typeof(uint), false, false, v8Value1, ref argobj1, ref argType1) && ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.Number, typeof(uint), false, false, v8Value2, ref argobj2, ref argType2) && ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.Number, typeof(uint), false, false, v8Value3, ref argobj3, ref argType3))
                ...
                if (paramLen == 2)
                {
                    ...
                    object argobj1 = null;
                    JsValueType argType1 = JsValueType.Invalid;
                    if (ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.BigInt, typeof(ulong), false, false, v8Value0, ref argobj0, ref argType0) && ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.BigInt, typeof(ulong), false, false, v8Value1, ref argobj1, ref argType1))
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to " + typeof(UnityEngine.Hash128).GetFriendlyName() + " constructor");
            } catch (Exception e) {
    ...
    // ==================== methods start ====================
        ...
        internal static void M_CompareTo(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    object argobj0 = null;
                    JsValueType argType0 = JsValueType.Invalid;
                    if (ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.NativeObject, typeof(UnityEngine.Hash128), false, false, v8Value0, ref argobj0, ref argType0))
                    {
                        UnityEngine.Hash128 arg0 = argobj0 != null ? (UnityEngine.Hash128)argobj0 : StaticTranslate<UnityEngine.Hash128>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void F_Compute(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void M_Append(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.Hash128)Puerts.Utils.GetSelf((int)data, self);
            ...
            {
                {
                    ...
                    {
                        UnityEngine.Hash128 arg0 = argobj0 != null ? (UnityEngine.Hash128)argobj0 : StaticTranslate<UnityEngine.Hash128>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
                        UnityEngine.Hash128 arg1 = argobj1 != null ? (UnityEngine.Hash128)argobj1 : StaticTranslate<UnityEngine.Hash128>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false);;
