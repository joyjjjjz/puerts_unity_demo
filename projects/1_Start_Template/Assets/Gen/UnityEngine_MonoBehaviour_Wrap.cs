        ...
        internal static void M_StartCoroutine(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    {
                        System.Collections.IEnumerator arg0 = argobj0 != null ? (System.Collections.IEnumerator)argobj0 : StaticTranslate<System.Collections.IEnumerator>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
        ...
        internal static void M_StopCoroutine(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    {
                        UnityEngine.Coroutine arg0 = argobj0 != null ? (UnityEngine.Coroutine)argobj0 : StaticTranslate<UnityEngine.Coroutine>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
