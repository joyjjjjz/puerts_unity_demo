    ...
    // ==================== properties start ====================
        ...
        internal static void S_sharedMaterial(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(isolate, info, 0);
                object argobj0 = null;
                UnityEngine.PhysicMaterial arg0 = argobj0 != null ? (UnityEngine.PhysicMaterial)argobj0 : StaticTranslate<UnityEngine.PhysicMaterial>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
