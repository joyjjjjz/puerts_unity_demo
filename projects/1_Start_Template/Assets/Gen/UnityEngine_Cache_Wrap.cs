        ...
        internal static void M_Equals(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    {
                        UnityEngine.Cache arg0 = argobj0 != null ? (UnityEngine.Cache)argobj0 : StaticTranslate<UnityEngine.Cache>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
            ...
            {
                {
                    ...
                    {
                        UnityEngine.Cache arg0 = argobj0 != null ? (UnityEngine.Cache)argobj0 : StaticTranslate<UnityEngine.Cache>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
                        UnityEngine.Cache arg1 = argobj1 != null ? (UnityEngine.Cache)argobj1 : StaticTranslate<UnityEngine.Cache>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false);;
