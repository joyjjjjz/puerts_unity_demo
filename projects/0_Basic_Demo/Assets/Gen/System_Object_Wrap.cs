...
#pragma warning disable 0219
    ...
    // ==================== methods start ====================
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void F_Equals(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void F_ReferenceEquals(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
