        ...
        internal static void F_RequestAdvertisingIdentifierAsync(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        
                {
                    ...
                    ;
                    {
                        UnityEngine.Application.AdvertisingIdentifierCallback arg0 = argobj0 != null ? (UnityEngine.Application.AdvertisingIdentifierCallback)argobj0 : StaticTranslate<UnityEngine.Application.AdvertisingIdentifierCallback>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
    ...
    // ==================== events start ====================
        ...
        internal static void A_lowMemory(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(isolate, info, 0);
                object argobj0 = null;
                UnityEngine.Application.LowMemoryCallback arg0 = argobj0 != null ? (UnityEngine.Application.LowMemoryCallback)argobj0 : StaticTranslate<UnityEngine.Application.LowMemoryCallback>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
        ...
        internal static void A_logMessageReceived(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(isolate, info, 0);
                object argobj0 = null;
                UnityEngine.Application.LogCallback arg0 = argobj0 != null ? (UnityEngine.Application.LogCallback)argobj0 : StaticTranslate<UnityEngine.Application.LogCallback>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
        ...
        internal static void A_deepLinkActivated(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(isolate, info, 0);
                object argobj0 = null;
                System.Action<string> arg0 = argobj0 != null ? (System.Action<string>)argobj0 : StaticTranslate<System.Action<string>>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
