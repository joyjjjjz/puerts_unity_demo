        ...
        internal static void M_AddListener(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        
                {
                    ...
                    ;
                    {
                        UnityEngine.Events.UnityAction<bool> arg0 = argobj0 != null ? (UnityEngine.Events.UnityAction<bool>)argobj0 : StaticTranslate<UnityEngine.Events.UnityAction<bool>>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false);;
